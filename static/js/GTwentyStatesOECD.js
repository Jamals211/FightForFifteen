...
d3.json('GTwentyStatesOECD.json').then (function(data)
{
...
//use pointToLayer to create circleMarkers
    pointToLayer: function(feature, latlng) 
    {
        ...
        {
            layer.bindPopup(`${"Minimum Wage: "+feature.properties.mag}<br><hr>${"Location: "+feature.properties.place}`)
        }
...
legend.onAdd = function () 
{
    ...
    const magnitudes = [0, 0.50, 4, 6, 8, 11];
    const colors = 
    [
      "#98ee00",
      "#d4ee00",
